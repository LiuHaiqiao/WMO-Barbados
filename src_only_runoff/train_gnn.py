"""
train_gnn.py — PyTorch Lightning training script for GNNFlood.
...
-----
# single GPU
python train_gnn.py --samples_dir /home/hl1138/TFNO/data/samples --static_dir /home/hl1138/TFNO/data/parms_bands

# custom batch size (keep small — 512×512 GNN is memory-heavy)
python train_gnn.py --samples_dir /path/to/samples --static_dir /path/to/static --batch_size 2

# resume from checkpoint
python train_gnn.py --samples_dir /home/hl1138/TFNO/data/samples --static_dir /home/hl1138/TFNO/data/parms_bands --ckpt_path logs/gnn/version_0/checkpoints/best.ckpt
"""
...
from train_fno import FNOLitModel   # model-agnostic Lightning module
...
def parse_args():
    ...
    p.add_argument('--hidden_dim',  type=int, default=64,
                   help='Node feature dimension in GNN layers')
