"""
train_cnn.py — PyTorch Lightning training script for UNetFlood (CNN baseline).
...
-----
# single GPU
python train_cnn.py --data_dirs /home/hl1138/TFNO/data

# multiple simulation dirs
python train_cnn.py --data_dirs /path/sim1 /path/sim2 --batch_size 4

# resume from checkpoint
python train_cnn.py --data_dirs /home/hl1138/TFNO/data --ckpt_path logs/unet/version_0/checkpoints/best.ckpt
"""
...
def parse_args():
    ...
    p.add_argument('--base_channels',  type=int, default=64,
                   help='Feature maps at first encoder level (doubles each level)')
